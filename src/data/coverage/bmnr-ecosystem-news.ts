...
export const ECOSYSTEM_NEWS: EcosystemNewsItem[] = [
  {
    id: "eco-news-xstocks-fundrise-vcx-2026-03-27",
    date: "2026-03-27",
    category: "institutional",
    company: "Payward (xStocks) / Fundrise",
    title: "xStocks and Fundrise Partner to Tokenize VCX Fund (VCXx) for Onchain Private Tech Exposure",
    sentiment: "bullish",
    summary: "xStocks (Payward / Kraken ecosystem) and Fundrise announced a partnership to tokenize the newly launched Fundrise Innovation Fund (NYSE: VCX), creating VCXx — a single onchain asset giving eligible investors exposure to a portfolio including SpaceX, OpenAI, Anthropic, Databricks, and other late-stage private names. The fund debuted publicly the prior week; tokenized VCXx is expected to go live on xStocks in the coming days. xStocks cites $25B+ combined transaction volume and 100K+ unique holders across 100+ tokenized stocks and ETFs. Communications note xStocks are not registered under the U.S. Securities Act and are not offered to U.S. persons.",
    significance: "Extends tokenized equities from public listings into a public venture fund wrapper, with collateralization/lending use cases highlighted. Reinforces institutional and global demand for regulated-style vehicles bridged to onchain rails.",
    bmnrImplication: "Does not affect BMNR operations directly. Supports the broader thesis that capital markets continue migrating onchain and that ETH-adjacent infrastructure (Base, Kraken/xStocks narrative) remains a high-activity venue — modest read-through for Ethereum ecosystem relevance, not for BMNR NAV or staking.",
    source: "Business Wire / Payward (2026-03-27)",
  },
  {
    id: "eco-news-m1x-global-usdm1-2026-03-27",
    date: "2026-03-27",
    category: "institutional",
    company: "M1X Global / Republic of the Marshall Islands",
    title: "M1X Global Launches Publicly; $3M Angel Round for USDM1 Sovereign On-Chain Debt",
    sentiment: "neutral",
    summary: "M1X Global announced its public launch and close of an oversubscribed $3 million angel round to scale USDM1 — described as USD-denominated, U.S. Treasury–collateralized sovereign debt issued natively on-chain by the Republic of the Marshall Islands, structured under New York law with a perfected security interest in collateral. The release positions USDM1 as programmable 24/7 settlement and mentions use as a disbursement rail (e.g. nationwide UBI pilot via Lomalo wallet). Advisors and investors named include Balaji Srinivasan, Cumberland Labs, FJ Labs, Stellar Development Foundation grant funding, and former BIS Secretary General Peter Dittus as advisor.",
    significance: "Illustrates sovereign and institutional experimentation with digitally native debt and treasury-collateralized instruments outside classic corporate treasury wrappers.",
    bmnrImplication: "Thematic only for BMNR: another data point on programmable cash and sovereign digital issuance; no direct link to Bitmine’s ETH balance sheet or staking economics.",
    source: "Business Wire / M1X Global (2026-03-27)",
  },
  {
    id: "eco-news-buidl-chronicle-poa-2026-03-26",
    date: "2026-03-26",
    category: "institutional",
    company: "BlackRock (BUIDL) / Securitize / Chronicle",
    title: "BUIDL Tokenized Fund Verified Onchain via Chronicle Proof of Asset",
    sentiment: "bullish",
    summary: "Chronicle announced that the BlackRock USD Institutional Digital Liquidity Fund (BUIDL), tokenized by Securitize and backed by short-term U.S. Treasuries, repos, and cash, is now supported by Chronicle Proof of Asset — attesting to availability, freshness, and integrity of holdings-level data for integrations. BlackRock’s Head of Digital Assets (Robert Mitchnick) is quoted on oracles and real-time transparency. Release cites ~$2.1B AUM for BUIDL and broader tokenized asset growth statistics.",
    significance: "Raises the bar for verifiable backing data on tokenized money-market products — relevant to institutional trust and secondary use (collateral, protocols).",
    bmnrImplication: "No direct BMNR impact. Slightly positive for Ethereum ecosystem seriousness as tokenized institutional cash products add transparency layers; orthogonal to corporate ETH treasury + staking.",
    source: "Business Wire / Chronicle (2026-03-26)",
  },
  {
    id: "eco-news-whop-treasury-2026-03-25",
    date: "2026-03-25",
    category: "product",
    company: "Whop",
    title: "Whop Announces Whop Treasury — Business Balances Earn Yield (up to ~6% APY), USDT on Plasma",
    sentiment: "neutral",
    summary: "Whop announced Whop Finance and its first product, Whop Treasury: businesses can hold balances in USDT (via Tether partnership), earn yield (cited up to ~6% APY) with real-time accrual and no minimum lockups, with biometric passkey authorization and per-merchant treasuries. Yield sourcing references Aave; infrastructure includes USDT0 on Plasma, Tether WDK, MoonPay onramps. Whop Payments Network revenue can auto-route into Treasury. Roadmap mentions additional assets including Bitcoin and Ethereum.",
    significance: "Adds another merchant-focused “active cash” product competing for business float, alongside broader stablecoin and DeFi yield plumbing.",
    bmnrImplication: "Ecosystem context only: reinforces demand for yield on idle business liquidity and stablecoin-native treasuries — different lane from public-company ETH NAV/staking but relevant when framing how capital competes for yield and attention.",
    source: "Business Wire / Whop (2026-03-25)",
  },
  {
    id: "eco-news-visa-canton-2026-03-25",
    date: "2026-03-25",
    category: "institutional",
    company: "Visa / Canton Network",
    title: "Visa Joins Canton Network as Super Validator for Privacy-Preserving Institutional Onchain Payments",
    sentiment: "bullish",
    summary: "Visa announced it will serve as a Super Validator on the Canton Network — described as privacy-oriented blockchain infrastructure for regulated finance — helping extend onchain payment, settlement, and treasury use cases for banks and FIs. Visa cites stablecoin settlement run-rate ($4.6B annualized globally), 130+ stablecoin-linked card programs across 50+ countries, and a Stablecoins Advisory Practice. Canton co-creator Digital Asset (Eric Saraniecki) quoted on production readiness.",
    significance: "Major payments network explicitly backing institutional-grade, privacy-preserving chain infrastructure — another bridge between TradFi settlement norms and onchain rails.",
    bmnrImplication: "No BMNR-specific read. Mildly supportive of long-dated institutional adoption of digital settlement; does not change ETH treasury fundamentals for Bitmine.",
    source: "Business Wire / Visa (2026-03-25)",
  },
  {
    id: "eco-news-bitgo-canton-cip56-2026-03-25",
    date: "2026-03-25",
    category: "institutional",
    company: "BitGo",
    title: "BitGo Extends Canton Custody to CIP-56 (USDCx, cBTC) Beyond Canton Coin",
    sentiment: "bullish",
    summary: "BitGo announced qualified custody support for CIP-56 token-standard assets on the Canton Network, including USDCx (Circle xReserve / selective disclosure structure) and cBTC (wrapped BTC for Canton settlement). BitGo frames CIP-56 as Canton’s regulated-market token standard with confidential transactions, DvP, KYC/AML controls, and fast finality. BitGo first launched Canton Coin custody in October 2025.",
    significance: "Expands institutional custody and movement of stablecoin and BTC liquidity on Canton — composable with repo/collateral workflows cited in the release.",
    bmnrImplication: "Peripheral to BMNR (ETH treasury). Relevant as market-structure context: more regulated venues for BTC/stablecoin settlement; no direct effect on Bitmine’s ETH holdings or staking.",
    source: "Business Wire / BitGo (2026-03-25)",
  },
  {
    id: "eco-news-mangrove-agentic-2026-03-25",
    date: "2026-03-25",
    category: "product",
    company: "Mangrove Technologies",
    title: "Mangrove Launches AI-Enabled Wealthtech Ecosystem for Digital Assets and Agentic Finance",
    sentiment: "neutral",
    summary: "Mangrove announced Mangrove, an AI-enabled wealthtech stack: consumer app for strategy design/testing with AI copilot and guardrails, plus developer APIs (x402-enabled) for autonomous trading workflows. Positioning emphasizes 24/7 digital asset markets and risk boundaries for AI agents. Release references recent SEC approval of Nasdaq’s proposal on tokenized securities trading as industry context.",
    significance: "Highlights convergence of advisory/wealth channels with automated and agent-driven execution — new operational risk and compliance themes for digital asset markets.",
    bmnrImplication: "Thematic only: more tooling and narratives around AI + crypto execution; no direct line to BMNR treasury math or comps unless Mangrove later partners with covered names.",
    source: "Business Wire / Mangrove Technologies (2026-03-25)",
  },
  {
    id: "eco-news-omnes-omn-base-2026-03-24",
    date: "2026-03-24",
    category: "institutional",
    company: "Omnes / Apex Group",
    title: "Omnes Partners With Apex to Tokenize Bitcoin Mining Structured Note (OMN) on Base",
    sentiment: "neutral",
    summary: "Omnes and Apex Group announced a partnership to tokenize the Omnes Mining Note (OMN) on Base — an institutional structured note described as secured debt issued in Luxembourg, giving professional non-U.S. investors economic exposure to new Bitcoin production (hashrate) without operating mining infrastructure. Apex Digital 3.0 covers tokenization, administration, and transfer agency. Base (Coinbase L2) and Jesse Pollak quoted on regulated onchain products.",
    significance: "Another institutional wrapper linking Bitcoin production economics to onchain transferability among whitelisted investors.",
    bmnrImplication: "BTC-production securitization narrative, not ETH corporate treasury. Low relevance to BMNR thesis except as general crypto capital-markets depth.",
    source: "Business Wire / Omnes (2026-03-24)",
  },
  {
    id: "eco-news-neos-iaui-etf-award-2026-03-23",
    date: "2026-03-23",
    category: "product",
    company: "NEOS Investments",
    title: "NEOS Gold High Income ETF (IAUI) Wins ETF.com Award; Suite Highlights NEHI Ethereum High Income ETF",
    sentiment: "neutral",
    summary: "NEOS announced the NEOS Gold High Income ETF (IAUI) won “Best New Options Income ETF” at the 2026 ETF.com Awards (community vote after quantitative/qualitative screening). Release discusses options-based income on gold and cites NEOS’ Alternative High Income suite, including BTCI (Bitcoin High Income ETF), IYRI, MLPI, and NEHI (Ethereum High Income ETF, launched December 2025) as peer products in the lineup.",
    significance: "Shows continued product innovation in options-income ETFs across BTC, ETH, gold, and other sleeves — expanding retail/ETF “yield on crypto/gold” shelf.",
    bmnrImplication: "NEHI and similar products compete for investor attention in “ETH + income” positioning but via options premia, not corporate balance-sheet ETH + staking. Useful for ecosystem framing; not a Comps entry unless explicitly added to COMPARABLES.",
    source: "Business Wire / NEOS Investments (2026-03-23)",
  },
  {
  ...
  },
  {
    ...
    significance: "Major payment network ($400B+ annual volume) quantifying global crypto adoption trajectory. 58% engagement (21% holding + 37% curious) indicates mainstream adoption approaching. Consumer expectation of crypto-payment integration validates Mastercard's infrastructure investments. EEMEA outperformance suggests emerging markets leading adoption.",
  ...
  },
  {
    ...
    title: "Coinbase and Shopify Bring USDC Payments on Base to Millions of Merchants Worldwide",
    sentiment: "bullish",
    summary: "Coinbase partners with Shopify to enable USDC payments on Base through Shopify Payments. Rolling out with early access merchants immediately, expanding to all Shopify Payments stores globally later in 2025. In the US, Shopify plans to provide 1% cash back to customers paying with USDC at no cost to the merchant. Powered by a new smart contract and commerce payments protocol developed jointly — deployed onchain, permissionless, and open source.",
    significance: "Massive merchant adoption milestone — Shopify powers millions of merchants globally. Open source commerce protocol creates permissionless payment infrastructure.",
    bmnrImplication: "Shopify USDC payments on Base directly drive Ethereum L2 transaction volume. More USDC commerce on Base = more Ethereum ecosystem value.",
    source: "Coinbase Blog",
  },
  {
    id: "eco-news-116",
  ...
  },
  {
    ...
    bmnrImplication: "Canadian stablecoin ecosystem development expands North American blockchain infrastructure. Major bank + fintech consortium model could accelerate regulated stablecoin adoption. Ethereum-compatible stablecoins expand network utility.",
  ...
  },
  {
    ...
    bmnrImplication: "Luxury brands building on Ethereum infrastructure validates network for enterprise non-financial use cases. Supply chain traceability expands Ethereum utility beyond DeFi. More enterprise adoption = more ecosystem value.",
    source: "Aura Blockchain Consortium Press Release",
  },
  {
    id: "eco-news-187",
  ...
  },
  {
    ...
    title: "Citi & Swift Complete Landmark Fiat-to-Digital Currency PvP Settlement Trial",
    sentiment: "bullish",
    summary: "Citi and Swift announce landmark trial proving feasibility of settling payments between fiat and digital currencies in Payment-versus-Payment (PvP) workflow. Used test USDC tokens from Circle on Ethereum Sepolia testnet. Novel approach: holistic messaging standard, escrow mechanism, central orchestrator. Citi GPS projects stablecoin market reaching $1.9T by 2030.",
    significance: "Citi ($2T assets) + Swift proving fiat-digital interoperability on Ethereum testnet. PvP mechanism eliminates settlement risk.",
    bmnrImplication: "Swift integrating Ethereum testnet validates network for global payments. More institutional testing = closer to production = ETH ecosystem value.",
    source: "Citi / Swift Press Release",
  },
  {
    id: "eco-news-193",
