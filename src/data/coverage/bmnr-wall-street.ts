...
export const WALL_STREET_FIRMS: WallStreetFirmCoverage[] = [
  {
    ...
    detail: {
      ...
      aiSummaryParagraphs: [
        "Initiation (Oct 2025) — Buy / $90 PT at launch; subsequent PT reset to $47 (Nov 2025) on revised mNAV and accumulation assumptions, reaffirmed Jan 2026.",
        "mNAV-based valuation. Views digital asset treasury companies (DATCo) as closed-end fund-like vehicles offering leveraged crypto exposure.",
      ],
      methodology:
